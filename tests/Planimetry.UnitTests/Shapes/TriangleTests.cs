...
public class TriangleTests
{
    ...
    {
        Action constructorInitialization = () => new Triangle(triplet[0], triplet[1], triplet[2]);
        Action fabricMethodInitialization = () => Triangle.From(triplet);
    ...
    {
        Action initialization = () => Triangle.From(triplet);
